...
const appData = {
  name: 'Gura Viktor',
  logo_name: 'Viktor',
  flat_picture: require('@/assets/images/potrait.svg'),
  ...
  portfolio: [
    {
      ...
      pictures: [
        {
          img: require('@/assets/images/portfolio/msr/one.png'),
        },
        {
          img: require('@/assets/images/portfolio/msr/two.png'),
        },
        {
          img: require('@/assets/images/portfolio/msr/three.png'),
        },
        {
          img: require('@/assets/images/portfolio/msr/four.png'),
        },
      ],
    ...
    },
    {
      ...
      pictures: [
        {
          img: require('@/assets/images/portfolio/noq/logo.png'),
        },
        {
          img: require('@/assets/images/portfolio/noq/one.png'),
        },
        {
          img: require('@/assets/images/portfolio/noq/two.png'),
        },
        {
          img: require('@/assets/images/portfolio/noq/three.png'),
        },
        {
          img: require('@/assets/images/portfolio/noq/four.png'),
        },
      ],
    ...
    },
    {
      ...
      pictures: [
        {
          img: require('@/assets/images/portfolio/post/one.png'),
        },
        {
          img: require('@/assets/images/portfolio/post/two.png'),
        },
      ],
      technologies: [
        'Markov Models',
    ...
    },
    {
      ...
      pictures: [
        {
          img: require('@/assets/images/portfolio/suicide/suicide-analyzer.png'),
        },
        {
          img: require('@/assets/images/portfolio/suicide/suicide2-original.png'),
        },
      ],
    ...
    },
    {
      ...
      pictures: [
        {
          img: require('@/assets/images/portfolio/smit/one.png'),
        },
        {
          img: require('@/assets/images/portfolio/smit/two.png'),
        },
        {
          img: require('@/assets/images/portfolio/smit/three.png'),
        },
        {
          img: require('@/assets/images/portfolio/smit/four.png'),
        },
      ],
    ...
    },
    {
      ...
      pictures: [
        {
          img: require('@/assets/images/portfolio/clumpr/logo.png'),
        },
        {
          img: require('@/assets/images/portfolio/clumpr/one.png'),
        },
        {
          img: require('@/assets/images/portfolio/clumpr/two.png'),
        },
      ],
    ...
    },
    {
      ...
      pictures: [
        {
          img: require('@/assets/images/portfolio/nc/one.png'),
        },
        {
          img: require('@/assets/images/portfolio/nc/two.png'),
        },
        {
          img: require('@/assets/images/portfolio/nc/three.png'),
        },
        {
          img: require('@/assets/images/portfolio/nc/four.png'),
        },
        {
          img: require('@/assets/images/portfolio/nc/five.png'),
        },
        {
          img: require('@/assets/images/portfolio/nc/six.png'),
        },
      ],
  ...
  portfolio_design: [
    {
      ...
      pictures: [
        {
          img: require('@/assets/images/designs/coursera1/MoodBoard.png'),
          title: 'MoodBoard',
        },
        {
          img: require('@/assets/images/designs/coursera1/Mockups 1.png'),
          title: 'Mockups 1',
        },
        {
          img: require('@/assets/images/designs/coursera1/Mockups 2.png'),
          title: 'Mockups 2',
        },
        {
          img: require('@/assets/images/designs/coursera1/App Elements.png'),
          title: 'App Elements',
        },
      ],
    ...
    },
    {
      ...
      pictures: [
        {
          img: require('@/assets/images/designs/pantree/MoodBoard.png'),
          title: 'Moodboard',
        },
        {
          img: require('@/assets/images/designs/pantree/1.png'),
          title: 'Mockups 1',
        },
        {
          img: require('@/assets/images/designs/pantree/2.png'),
          title: 'Mockups 2',
        },
      ],
      technologies: ['XD', 'Illustrator'],
    ...
    },
    {
      ...
      pictures: [
        {
          img: require('@/assets/images/designs/bunder/Moodboard.png'),
          title: 'Moodboard',
        },
        {
          img: require('@/assets/images/designs/bunder/Mockup 1.png'),
          title: 'Mockup 1',
        },
        {
          img: require('@/assets/images/designs/bunder/Mockup 2.png'),
          title: 'Mockup 2',
        },
        {
          img: require('@/assets/images/designs/bunder/Mockup 3.png'),
          title: 'Mockup 3',
        },
        {
          img: require('@/assets/images/designs/bunder/Market Research 1.png'),
          title: 'Market Research 1',
        },
        {
          img: require('@/assets/images/designs/bunder/Market Research 2.png'),
